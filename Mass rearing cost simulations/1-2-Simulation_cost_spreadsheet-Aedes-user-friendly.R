...
#### > 0. General parameters (to be set) ####
...
range.production = c(0.5, 1, 2, 5)

# Set up the number of weeks with releases per year (all year round = 52, half = 26)
wks.release = 26

#Write the date of your simulation
...
parameter.lists = {list(
  production.goals = 
    list(
      Weekly_pupal_production = NA, 
      Number_of_weeks_with_releases_per_year = wks.release 
    ),
...
# For plotting comparative results (different methods and/or production ranges), see
# R code "Simulation_outputs_spreadsheet.R"
